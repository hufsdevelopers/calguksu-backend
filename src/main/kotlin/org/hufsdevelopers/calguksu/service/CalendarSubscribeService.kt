    ...
    fun sendSubscribeMail(subscriberEntity: SubscriberEntity, targetCalendarEntity: CalendarEntity) {
        ...
        hufsDevelopersMailService.send(
            ...
            "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\"\n" +
                    ...
                    "                  <p\n" +
                    "                    style=\"margin: 0; padding: 0; font-family: BlinkMacSystemFont, 'Apple SD Gothic Neo', '맑은 고딕', sans-serif; font-size: 30px; font-weight: 600; line-height: 1.42; letter-spacing: -0.21px; color: #1A202C; -webkit-text-size-adjust: 100%;\">\n" +
                    ...
                    "                <td align=\"center\">\n" +
                    "                  <p\n" +
                    "                    style=\"margin: 0; padding: 0; font-family: BlinkMacSystemFont, 'Apple SD Gothic Neo', '맑은 고딕', sans-serif; font-size: 16px; font-weight: 400; line-height: 1.42; letter-spacing: -0.21px; color: #4A5568; -webkit-text-size-adjust: 100%;\">\n" +
                    ...
                    "                     style=\"color: #1A202C; font-family: BlinkMacSystemFont, 'Apple SD Gothic Neo', '맑은 고딕', sans-serif; font-size: 14px; font-weight: 400; line-height: 1.42; letter-spacing: -0.21px; webkit-text-size-adjust: 100%;\">1,000원\n" +
                    "                    후원으로 33명의 외대생에게 서비스를 제공할 수 있습니다</a>\n" +
                    "                </td>\n" +
                    "              </tr>\n" +
                    "              </tbody>\n" +
                    "            </table>\n" +
                    ...
                    "      <p\n" +
                    "        style=\"margin: 0; padding: 0; font-family: BlinkMacSystemFont, 'Apple SD Gothic Neo', '맑은 고딕', sans-serif; font-size: 12px; font-weight: 400; line-height: 1.6; letter-spacing: -0.21px; color: #4A5568; -webkit-text-size-adjust: 100%;\">\n" +
